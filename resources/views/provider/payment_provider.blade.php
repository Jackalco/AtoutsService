...
@section('content')
    <!--<form method="post" action="{{ route('payment') }}" class="paymentContainer" data-cc-on-file="false" data-stripe-publishable-key="{{ env('STRIPE_KEY') }}" id="stripe-payment">
        <div class='paymentItem'>
            <input class='form-control' type='text' placeholder="Nom du titulaire">
        </div> 
        <div class="paymentItem">     
            <input autocomplete='off' class='form-control card-num' size='20' type='text' placeholder="Numéro de la carte">
            <input autocomplete='off' class='form-control card-cvc' placeholder='CVC' size='3' type='text'>
            <input class='form-control card-expiry-month' placeholder='MM' size='2' type='text'>
            <input class='form-control card-expiry-year' placeholder='YY' size='2' type='text'>
        </div>
        <div class="paymentItem">
            <button type="submit" class="paymentButton">Payer</button>
        </div>
    </form>-->
