...
@section('content')
    ...
    <section class="legalContainer">
        <div class="legalItem">
            <h2>Présentation</h2>
            <div><strong>Propriètaire :</strong> Atouts Services A Tout Ages</div>
            ...
            <div><strong>Téléphone :</strong> 07 53 12 54 60</div>
        ...
        <div class="legalItem">
            ...
            <p>L’utilisation du site Atouts Services implique l’acceptation pleine et entière des conditions générales d’utilisation ci-après décrites. Ces conditions d’utilisation sont susceptibles d’être modifiées ou complétées à tout moment, les utilisateurs du site Atouts Services A Tout Ages sont donc invités à les consulter de manière régulière.</p>
        </div>
        <div class="legalItem">
            <h2>Limitations de responsabilité</h2>
            <p>Atouts Services ne pourra être tenu responsable des dommages directs et indirects causés au matériel de l’utilisateur, lors de l’accès au site Atouts Services A Tout Ages, et résultant soit de l’utilisation d’un matériel ne répondant pas aux spécifications indiquées, soit de l’apparition d’un bug ou d’une incompatibilité.</p>
            <p>Atouts Services ne pourra également être tenu responsable des dommages indirects (tels par exemple qu’une perte de marché ou perte d’une chance) consécutifs à l’utilisation du site Atouts Services A Tout Ages</p>
        </div>
        <div class="legalItem">
        ...
        <div class="legalItem">
            ...
            <p>Le site Atouts Services A Tout Ages contient un certain nombre de liens hypertextes vers d’autres sites. Cependant, Atouts Services n’a pas la possibilité de vérifier le contenu des sites ainsi visités, et n’assumera en conséquence aucune responsabilité de ce fait.</p>
        </div>
        <div class="legalItem">
            <h2>Droit applicable et attribution de juridiction</h2>
            <p>Tout litige en relation avec l’utilisation du site Atouts Services A Tout Ages est soumis au droit français. En dehors des cas où la loi ne le permet pas, il est fait attribution exclusive de juridiction aux tribunaux compétents de Saint-Brévin.</p>
        </div>
    </section>
@endsection